...
public class CompletedSessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<MySessionActivity.ListData>();
...
//                    MySessionActivity.ListData listData = new MySessionActivity.ListData(sessionInformation.name,sessionInformation.timeFrom,sessionInformation.timeTo,sessionInformation.completed);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CompletedSessionActivity.this,ProfileActivity.class));
        finish();
    }
    ...
    public static class ListData{
        ...
        public ListData(String name, String from, String to, boolean status) {
